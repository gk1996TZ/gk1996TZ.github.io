...
public class GpsDataLine extends BaseEntity{
	...
	public GpsDataLine(String vehicleNo, Integer vehicleColor, Long longitude, Long latitude, String location,
	...
	public double[] getLnglat() {
		...
		if(lnglat.length == 2){
			...
			if(lat != null && lon != null){
				double[] gcjs = CoordinateConverter.wgs2GCJ(lat, lon);
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		GpsDataLine other = (GpsDataLine) obj;
	...
	public String toString() {
		return "GpsDataLine [vehicleNo=" + vehicleNo + ", vehicleColor=" + vehicleColor + ", longitude=" + longitude
				+ ", latitude=" + latitude + "]";
	}
}
