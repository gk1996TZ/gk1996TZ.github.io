...
public class CoordinateConverter {
    ...
    public static synchronized double[] gcj2BD09(double glat, double glon) {
        double x = glon;
        double y = glat;
    ...
    public static synchronized double[] bd092GCJ(double glat, double glon) {
    ...
    public static synchronized double[] bd092WGS(double glat, double glon) {
        double[] latlon = bd092GCJ(glat, glon);
        return gcj2WGS(latlon[0], latlon[1]);
    }

    // WGS84=》BD09 地球坐标系=>百度坐标系
    public static synchronized double[] wgs2BD09(double wgLat, double wgLon) {
        double[] latlon = wgs2GCJ(wgLat, wgLon);
        return gcj2BD09(latlon[0], latlon[1]);
    }

    // GCJ02=>WGS84 火星坐标系=>地球坐标系(粗略)
    public static synchronized double[] gcj2WGS(double glat, double glon) {
        double[] latlon = new double[2];
    ...
    public static synchronized double[] gcj2WGSExactly(double gcjLat, double gcjLon) {
    ...
    // 两点距离
    public static synchronized double distance(double latA, double logA, double latB, double logB) {
        int earthR = 6371000;
    ...
    public static synchronized double[] delta(double wgLat, double wgLon) {
    ...
    public static synchronized boolean outOfChina(double lat, double lon) {
    ...
    public static synchronized double transformLat(double x, double y) {
    ...
    public static synchronized double transformLon(double x, double y) {
    ...
    public static synchronized double[] mapBar2WGS84(double mapbarLon, double mapbarLat) {
    ...
    public static synchronized double[] wgs2GCJ(double wgLat, double wgLon) {
        double[] latlon = new double[2];
    ...
    public static void main(String[] args) {
    	...
    	double y1 = 119.641402;
    	
    	double[] xs = gcj2WGS(x1,y1);
