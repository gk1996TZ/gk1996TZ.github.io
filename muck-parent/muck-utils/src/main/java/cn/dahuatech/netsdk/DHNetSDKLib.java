 ...
 * 大华SDK JNA接口封装
 *//*
public interface DHNetSDKLib extends StdCallLibrary{
	
	DHNetSDKLib INSTANCE = (DHNetSDKLib) Native.loadLibrary("dhnetsdk",
			DHNetSDKLib.class);
...
//事件类型 EVENT_IVS_CLIMBDETECTION(攀高检测事件)对应数据块描述信息
	...
	*//************************************************************************
	...
	public interface fDownLoadPosCallBack extends Callback {
		public void invoke(long lPlayHandle, int dwTotalSize, int dwDownLoadSize, long dwUser);
	}
	...
	*//************************************************************************
	...
	public NativeLong  CLIENT_DownloadByTime(long lLoginID, int nChannelId,
			int nRecordFileType, NET_TIME tmStart, NET_TIME tmEnd,
			String sSavedFileName, fDownLoadPosCallBack cbTimeDownLoadPos,
			long dwUserData);
