package com.litang.controller.aspect;
...
import com.litang.exception.base.ParameterIllegalException;
import com.litang.request.BaseForm;
 ...
 */
@Aspect
@Component("FrontMethodParameterAspect")
public class MethodParameterAspect {
	
	private final String VALIDATE_METHOD_NAME = "validate";
	
	@Pointcut("execution(* com.litang.controller.*Controller.*(..))")
